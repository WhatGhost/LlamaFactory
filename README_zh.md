...
- **AMD GPU Cloud (免费)**: [AMD 开发者云：兑换免费云算力小时 并启动 LLaMA-Factory](https://github.com/AMD-AIM/AMD_Developers_Notebooks/blob/main/zh/AMD_developer_LLaMAFactory_note_zh.md)
