...
- **AMD GPU Cloud (free credits)**: [AMD Developer Cloud: Redeem Credits and Launch LLaMA-Factory](https://github.com/AMD-AIM/AMD_Developers_Notebooks/blob/main/en/AMD_developer_LLaMAFactory_note_en.md)
